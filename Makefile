...
DEBUG_CFLAGS      = $(BASE_CFLAGS) -O0 -g -DLC_DEBUG -Iinclude $(POSIX_FLAGS)
DEBUG_CXXFLAGS    = $(BASE_CXXFLAGS) -O0 -g -DLC_DEBUG -Iinclude $(POSIX_FLAGS)

SANITIZE_CFLAGS   = $(BASE_CFLAGS) -O0 -g -fsanitize=address,undefined -DLC_DEBUG -Iinclude $(POSIX_FLAGS)
SANITIZE_CXXFLAGS = $(BASE_CXXFLAGS) -O0 -g -fsanitize=address,undefined -DLC_DEBUG -Iinclude $(POSIX_FLAGS)
